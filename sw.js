...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "web_api_url": true,
        "web_attr_string_unified_vis_mon": true,
        "web_attributed_string_race_fix": true,
        ...
        "web_graft_ve_unified_vis_mon": true,
        ...
        "web_wiz_attributed_string_skip_empty": true,
        ...
        "web_load_prediction_threshold": 0.03,
        "web_navigation_prediction_threshold": 0.03,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20251109.10.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "IN",
            "clientName": "WEB",
            "clientVersion": "2.20251109.10.00"
        }
    },
    "INNERTUBE_CONTEXT_CLIENT_NAME": 1,
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20251109.10.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/efba2ec4\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/efba2ec4\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}
